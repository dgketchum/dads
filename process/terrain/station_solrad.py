...
def write_station_solrad(stations, tile_dir, station_out, shuffle=False, overwrite=False, index_col='fid'):
...
if __name__ == '__main__':
    ...
    write_station_solrad(shapefile_path_, solrad_tiled, solrad_out, shuffle=True, overwrite=False, index_col='fid')
