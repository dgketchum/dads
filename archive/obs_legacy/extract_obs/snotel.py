...
from utils.state_county_names_codes import state_name_abbreviation
...
URL_LEAD = (
    "https://wcc.sc.egov.usda.gov/reportGenerator/view_csv/customGroupByMonthReport"
)
...
def snotel_meteorology(csv, out_dir, overwrite=False):
    ...
    for _id, row in df.iterrows():
        ...
        for url_str, var in zip(URL_STRINGS, vars_):
            url = "{}/daily/{}:{}:SNTL%7Cid=%22%22%7Cname/POR_BEGIN,POR_END/{}".format(
                URL_LEAD, row["ID"], st, url_str
            )
