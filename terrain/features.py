    ...
    for tile in tiles:
        ...
        try:
            ...
            data = stack.reduceRegions(
                collection=tile_pts, reducer=ee.Reducer.mean(), scale=90, tileScale=16
            )
...
def get_terrain_image():
    ...
    tpi_500 = (
        elev.subtract(elev.focal_mean(500, "circle", "meters"))
        .add(0.5)
        .rename("tpi_500")
    )
    tpi_2500 = (
        elev.subtract(elev.focal_mean(2500, "circle", "meters"))
        .add(0.5)
        .rename("tpi_2500")
    )
    tpi_10000 = (
        elev.subtract(elev.focal_mean(10000, "circle", "meters"))
        .add(0.5)
        .rename("tpi_10000")
    )
    tpi_22500 = (
        elev.subtract(elev.focal_mean(22500, "circle", "meters"))
        .add(0.5)
        .rename("tpi_22500")
    )
