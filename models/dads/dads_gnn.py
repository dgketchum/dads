...
class DadsMetGNN(pl.LightningModule):
    ...
    def __init__(self, output_dim, n_nodes=5, hidden_dim=64, edge_attr_dim=20,
                 dropout=0.1, learning_rate=1e-3, log_csv=None,
        ...
        self.edge_gate = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(gate_hidden, 1),  # no final activation; we apply softplus at runtime
        )
    ...
    def _forward_gnn(self, graph):
        ...
        try:
            ...
            ea = graph.edge_attr.float()  # includes dynamic exog delta and distance when available
            ...
            w_e = F.softplus(gate_logit) + 1e-6  # positive, unbounded; small epsilon avoids zeros
