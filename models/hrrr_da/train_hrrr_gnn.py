"""
Train HRRR bias correction GNN.

TOML config + CLI overrides, using LitDadsGNN from models.components.
"""
...
class HRRRGNNConfig:
    ...
    @classmethod
    def from_toml(cls, path: str) -> HRRRGNNConfig:
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train HRRR bias GNN.")
...
def _build_config(args: argparse.Namespace) -> HRRRGNNConfig:
    if args.config:
        cfg = HRRRGNNConfig.from_toml(args.config)
    else:
        cfg = HRRRGNNConfig()
