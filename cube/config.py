...
LANDSAT_FEATURES = ['landsat_b2', 'landsat_b3', 'landsat_b4',
                    'landsat_b5', 'landsat_b6', 'landsat_b7', 'landsat_b10']
...
class CubeConfig:
    ...
    """
    cube_path: Path = field(default_factory=lambda: Path('/data/ssd2/dads_cube/cube.zarr'))
    ...
    def __post_init__(self):
        ...
        self.source_paths = {k: Path(v) if not isinstance(v, Path) else v
